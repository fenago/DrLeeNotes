  ...
  return (
    <div className="relative h-[350px] w-full  px-4 md:h-[605px] md:px-6 lg:px-8 xl:px-10 2xl:px-0">
      <div className="flex h-full w-full flex-col items-center justify-center">
        <div className="mb-5 rounded-2xl border border-black px-4 py-1 text-sm text-slate-600 sm:text-base">
          Powered by <span className="font-bold">Dr. Ernesto Lee</span>
        </div>
        <h1 className="inline-block text-center text-4xl font-medium tracking-tighter text-dark lg:text-7xl">
          Agentic AI Powered Voice <br className="hidden lg:inline-block" />
          Note Taking
        </h1>
        <p className="mt-8 text-center text-xl font-light tracking-tight lg:text-3xl">
          <span className="font-bold">A</span>gentic<span className="font-bold">N</span>otes seamlessly converts your voice notes into{' '}
